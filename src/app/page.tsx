  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white px-6 md:px-20 py-10">
      ...
      <header className="flex justify-between items-center">
        ...
        <nav>
          <a href="#gameprojects" className="mx-3 hover:text-blue-400">Game Projects</a>
      ...
      <section className="mt-16 text-center">
        ...
        <a href="#gameprojects" className="mt-6 inline-block px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-full">
          View My Work
        </a>
      </section>

{/* Game Projects Section */}
<section id="gameprojects" className="mt-20">
  <h2 className="text-3xl font-bold">Game Projects</h2>
